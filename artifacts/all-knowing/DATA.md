...
| `sourced/npc-placements.json` | Every placed NPC/enemy and its world position, from the map MSBs (`scripts/extract-npc-placements.py`): 26,997 placements, 912 distinct NPCs, 95 flagged `dialogue`. Position is the part's raw local position; `src/lib/npcPlacements.ts` matcher. |
