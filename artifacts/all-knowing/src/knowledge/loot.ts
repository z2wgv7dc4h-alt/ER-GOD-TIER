...
export const loot: Loot[] = [
  ...
  { id: 'loot:giant-crusher', name: 'Giant-Crusher', aliases: ['crusher'], kind: 'weapon', region: 'various', campaign: 'base', how: 'Heavy greathammer from a mid-game chest.' },
  ...
  { id: 'loot:dragon-communion-seal', name: 'Dragon Communion Seal', aliases: ['dc seal'], kind: 'weapon', region: 'various', campaign: 'base', how: 'Seal obtained through the Dragon Communion altar chain.' },
  ...
  { id: 'loot:axe-talisman', name: 'Axe Talisman', aliases: ['axe talisman'], kind: 'talisman', region: 'various', campaign: 'base', how: 'Found in a chest in the mid-game ruins.' },
  ...
  { id: 'loot:greatshield-talisman', name: 'Greatshield Talisman', aliases: ['greatshield talisman'], kind: 'talisman', region: 'various', campaign: 'base', how: 'Found in a late-game chest.' },
  { id: 'loot:spear-talisman', name: 'Spear Talisman', aliases: ['spear talisman'], kind: 'talisman', region: 'various', campaign: 'base', how: 'Found in a mid-game chest.' },
