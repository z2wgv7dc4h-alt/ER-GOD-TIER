...
export const storylines: Line[] = [
  ...
  },
  {
    ...
    lockedIf: () => null,
    steps: [
      { id: 'a1', do: 'Free Alexander from the Limgrave hole', detail: 'South of Stormhill. Hit the ground. Missable if you never crack it, but he can still show later.', factId: 'quest:alexander:met', factIds: ['alexander-1'], module: 'quests', requires: [], grants: ['alexander-1', 'quest:alexander:met'], lockouts: ['quest:alexander:missed-limgrave'] },
      { id: 'a2', do: 'Find him again near Gael Tunnel in Caelid', detail: 'He waits by the tunnel and asks you to meet him at the Redmane festival.', factId: 'quest:alexander:gael', module: 'map', minLevel: 50, requires: ['quest:alexander:met'], grants: ['quest:alexander:gael'], lockouts: ['quest:alexander:missed-limgrave'] },
      { id: 'a2b', do: 'Fight beside him at the Redmane festival', detail: 'Speak to him in the Redmane Castle plaza, then summon him for Starscourge Radahn.', factId: 'boss:radahn', module: 'map', minLevel: 70, requires: ['quest:alexander:gael'], grants: ['boss:radahn', 'quest:alexander:festival'], lockouts: ['quest:alexander:missed-limgrave'] },
      ...
      { id: 'a4', do: 'Recover Alexander’s Innards where he fell', detail: 'He shatters after the duel; the Innards are left in the Farum Azula clearing.', factId: 'item:alexanders-innards', module: 'map', minLevel: 110, requires: ['quest:alexander:complete'], grants: ['item:alexanders-innards'], lockouts: [] },
      { id: 'a5', do: 'Carry the Innards to Jar-Bairn in Jarburg', detail: 'The nephew in Liurnia’s jar village vows to grow as strong as his uncle.', factId: 'quest:jarbairn:concluded', module: 'map', minLevel: 60, requires: ['item:alexanders-innards'], grants: ['quest:jarbairn:concluded'], lockouts: [] },
    ],
  },
  {
    id: 'varre',
  ...
  },
  {
    ...
    lockedIf: () => null,
    steps: [
      { id: 'boc1', do: 'Free Boc from the illusory tree in Limgrave', detail: 'Strike the talking tree east of the path south of Agheel Lake North. He rewards you with mushrooms and turns up at a grace.', factId: 'quest:boc:freed', module: 'quests', requires: [], grants: ['quest:boc:freed'], lockouts: [] },
      { id: 'boc2', do: 'Meet Boc at the Coastal Cave entrance', detail: 'South-west of Agheel Lake, on the coast. He follows you from grace to grace and asks to be your seamster.', factId: 'quest:boc:cave', module: 'map', minLevel: 30, requires: ['quest:boc:freed'], grants: ['quest:boc:cave'], lockouts: [] },
      { id: 'boc3', do: 'Give Boc the Gold Sewing Needle', detail: 'Dropped by the Demi-Human Chiefs in the Coastal Cave. He becomes a proper seamster and can tailor your armour for free.', factId: 'quest:boc:needle', module: 'quests', minLevel: 40, requires: ['quest:boc:cave'], grants: ['quest:boc:needle'], lockouts: [] },
      { id: 'boc4', do: 'Hear Boc doubt his looks in Leyndell', detail: 'Once you reach the capital he despairs of being a demi-human and asks to be reborn.', factId: 'quest:boc:doubt', module: 'quests', minLevel: 80, requires: ['quest:boc:needle'], grants: ['quest:boc:doubt'], lockouts: [] },
      { id: 'boc5', do: 'Reassure Boc with the Prattling Pate “You’re Beautiful”', detail: 'The pate keeps him content as your seamster. This is the good end for the line.', factId: 'quest:boc:beautiful', module: 'quests', minLevel: 90, requires: ['quest:boc:doubt'], grants: ['quest:boc:beautiful'], lockouts: ['quest:boc:rebirth'], lockout: 'Telling him he is ugly, or leaving the doubt unanswered, sends him to Rennala for a larval tear and ends the line.' },
      { id: 'boc6', do: 'Or send Boc to seek rebirth', detail: 'Giving him a Larval Tear ends the seamster line and leaves him changed. The two outcomes are exclusive.', factId: 'quest:boc:rebirth', module: 'quests', minLevel: 90, requires: ['quest:boc:doubt'], grants: ['quest:boc:rebirth'], lockouts: ['quest:boc:beautiful'], lockout: 'The rebirth and the reassurance are mutually exclusive.' },
    ],
  },
  {
    id: 'nepheli',
    ...
    lockedIf: () => null,
    steps: [
      { id: 'nepheli1', do: 'Meet Nepheli inside Stormveil Castle', detail: 'Side room past the early Stormhawks before the Liftside Chamber. Exhaust her dialogue and her summon sign appears for Godrick.', factId: 'quest:nepheli:met', module: 'quests', minLevel: 30, requires: [], grants: ['quest:nepheli:met'], lockouts: [] },
      { id: 'nepheli1b', do: 'Speak with her outside Gideon’s study', detail: 'Roundtable Hold, after Godrick. She gives the Arsenal Charm if you met her or summoned her for the fight.', factId: 'quest:nepheli:roundtable', module: 'quests', minLevel: 40, requires: ['quest:nepheli:met'], grants: ['quest:nepheli:roundtable'], lockouts: [] },
      { id: 'nepheli1c', do: 'Find her in despair after the Omenkiller', detail: 'After the Village of the Albinaurics boss she sits near Hewg’s stairs. Tell Gideon about her.', factId: 'quest:nepheli:despair', module: 'quests', minLevel: 60, requires: ['quest:nepheli:roundtable'], grants: ['quest:nepheli:despair'], lockouts: ['quest:nepheli:potioned'] },
      { id: 'nepheli2', do: 'Refuse Seluvis’s potion test', detail: 'Seluvis asks you to test the potion on her. Giving it to her ends her line and makes her a puppet.', factId: 'quest:nepheli:refused-potion', module: 'quests', requires: ['quest:nepheli:despair'], grants: ['quest:nepheli:refused-potion'], lockouts: ['quest:nepheli:potioned'], lockout: 'Handing Nepheli Seluvis’s potion forecloses her rule of Limgrave.' },
  ...
  },
  {
    ...
    lockedIf: () => null,
    steps: [
      { id: 'hy1', do: 'Meet Hyetta at the Lake-Facing Cliffs', detail: 'Liurnia, past Stormveil. She appears only after Irina is dead, and asks for a Shabriri Grape.', factId: 'quest:hyetta:met', module: 'map', minLevel: 30, requires: [], grants: ['quest:hyetta:met'], lockouts: [] },
      { id: 'hy2', do: 'Give her the first Shabriri Grape', detail: 'At the Lake-Facing Cliffs. Tell her the grapes are human eyes when she asks.', factId: 'quest:hyetta:grapes', module: 'map', minLevel: 30, requires: ['quest:hyetta:met'], grants: ['quest:hyetta:grapes'], lockouts: [] },
      { id: 'hy3', do: 'Bring a Shabriri Grape to the Purified Ruins', detail: 'South Liurnia. The second grape sits in the ruins’ hidden cellar behind the barrels.', factId: 'quest:hyetta:purified', module: 'map', minLevel: 40, requires: ['quest:hyetta:grapes'], grants: ['quest:hyetta:purified'], lockouts: [] },
      { id: 'hy4', do: 'Bring a Shabriri Grape to the Gate Town Bridge', detail: 'The third grape is dropped by Edgar the Revenger when he invades near the Revenger’s Shack.', factId: 'quest:hyetta:gatetown', module: 'map', minLevel: 50, requires: ['quest:hyetta:purified'], grants: ['quest:hyetta:gatetown'], lockouts: [] },
      { id: 'hy5', do: 'Bring the Fingerprint Grape to Bellum Church', detail: 'Defeat Festering Fingerprint Vyke near the Church of Inhibition for the Fingerprint Grape.', factId: 'quest:hyetta:bellum', module: 'map', minLevel: 70, requires: ['quest:hyetta:gatetown'], grants: ['quest:hyetta:bellum'], lockouts: [] },
      { id: 'hy6', do: 'Meet Hyetta at the Frenzied Flame Proscription', detail: 'She reveals she is a maiden of the Three Fingers. Taking the flame commits the Frenzy ending.', factId: 'quest:hyetta:maiden', module: 'quests', minLevel: 80, requires: ['quest:hyetta:bellum'], grants: ['quest:hyetta:maiden'], lockouts: ['quest:hyetta:killed'], lockout: 'Killing Hyetta, or taking the Frenzied Flame before this beat, forecloses her revelation.' },
    ],
  },
  {
    id: 'sellen',
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'ir2', do: 'Deliver the letter to Edgar at Castle Morne', detail: 'Find him atop the ramparts. He refuses to leave while the Misbegotten hold the castle.', factId: 'quest:edgar:letter', module: 'map', minLevel: 30, requires: ['quest:irina:met'], grants: ['quest:edgar:letter'], lockouts: ['quest:irina:killed'] },
      { id: 'ir3', do: 'Clear the Leonine Misbegotten from Castle Morne', detail: 'Deliver the letter before the boss. The Leonine drops the Grafted Blade Greatsword on the shore.', factId: 'quest:irina:castle', module: 'map', minLevel: 35, requires: ['quest:edgar:letter'], grants: ['quest:irina:castle'], lockouts: ['quest:irina:killed'] },
      { id: 'ir4', do: 'Report back to Edgar and find Irina', detail: 'Edgar speaks of returning to her; ride back to the Bridge of Sacrifice to see the outcome.', factId: 'quest:irina:dead', module: 'map', minLevel: 35, requires: ['quest:irina:castle'], grants: ['quest:irina:dead'], lockouts: ['quest:irina:killed'] },
      { id: 'ir5', do: 'Face Edgar the Revenger at the Revenger’s Shack', detail: 'After Irina is found dead, Edgar invades you on the east Liurnia road. Missable if you never return.', factId: 'quest:edgar:revenger', module: 'map', minLevel: 50, requires: ['quest:irina:dead'], grants: ['quest:edgar:revenger'], lockouts: ['quest:irina:killed'] },
      { id: 'ir6', do: 'Recover the Shabriri Grape Edgar carried', detail: 'The Revenger drops the grape Hyetta needs for her Gate Town Bridge step.', factId: 'item:shabriri-grape', module: 'map', minLevel: 50, requires: ['quest:edgar:revenger'], grants: ['item:shabriri-grape'], lockouts: [] },
    ],
  },
  {
    id: 'seluvis',
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'ig2', do: 'Meet him again at the peak’s edge', detail: 'He is spent but still points you at Bayle. His summon sign appears once the boss does.', factId: 'quest:igon:peak', module: 'map', minLevel: 150, requires: ['quest:igon:met'], grants: ['quest:igon:peak'], lockouts: ['boss:bayle'], lockout: 'Bayle must be alive for the summon and the payoff.' },
      { id: 'ig2b', do: 'Summon Igon at the Bayle fog gate', detail: 'The sign is inside the arena to the left. Summoning him is optional for the kill but required for his set and bell bearing.', factId: 'quest:igon:summon', module: 'map', minLevel: 160, requires: ['quest:igon:peak'], grants: ['quest:igon:summon'], lockouts: ['boss:bayle'], lockout: 'Summoning must happen before Bayle dies.' },
      { id: 'ig3', do: 'Kill Bayle the Dread', detail: 'Bayle drops the Heart of Bayle; Igon’s revenge is fulfilled if he was summoned.', factId: 'boss:bayle', module: 'map', minLevel: 160, obtain: 'Igon’s Harpoon', requires: ['quest:igon:summon'], grants: ['boss:bayle', 'quest:igon:concluded'], lockouts: [] },
      { id: 'ig4', do: 'Take Igon’s Harpoon where he fell', detail: 'After the fight, collect his harpoon and the Dragon Hunter’s Great Katana from the summit.', factId: 'item:igons-harpoon', module: 'map', minLevel: 160, requires: ['boss:bayle'], grants: ['item:igons-harpoon'], lockouts: [] },
    ],
  },
  {
    id: 'thiollier',
  ...
  },
  {
    ...
    kind: 'story',
    name: 'Patches',
    aliases: ['patches', 'murkwater', 'unbreakable patches'],
    lockedIf: () => null,
    steps: [
      { id: 'pt1', do: 'Survive Patches’s ambush in Murkwater Cave', detail: 'Limgrave, upstream of the ravine. Let his HP drop and he surrenders.', factId: 'quest:patches:ambush', module: 'map', minLevel: 20, requires: [], grants: ['quest:patches:ambush'], lockouts: [] },
      { id: 'pt2', do: 'Forgive Patches and open his shop', detail: 'Spare him and he becomes a merchant; he sells the Magma Whip Candlestick and Stonesword Keys later.', factId: 'quest:patches:forgiven', module: 'map', minLevel: 20, requires: ['quest:patches:ambush'], grants: ['quest:patches:forgiven'], lockouts: [] },
      { id: 'pt3', do: 'Find Patches again at Volcano Manor', detail: 'After you join the manor he relocates there as a vendor.', factId: 'quest:patches:volcano', module: 'map', minLevel: 60, requires: ['quest:patches:forgiven'], grants: ['quest:patches:volcano'], lockouts: [] },
      { id: 'pt4', do: 'Finish the Volcano Manor contracts', detail: 'The named contract targets must be done before Rykard; Patches’s own arc needs them complete.', factId: 'quest:patches:contracts', module: 'map', minLevel: 90, requires: ['quest:patches:volcano'], grants: ['quest:patches:contracts'], lockouts: [] },
      { id: 'pt5', do: 'Find Patches wounded at the Shaded Castle', detail: 'After Rykard is dead he lies on the castle ramparts in the Altus poison mire.', factId: 'quest:patches:shaded', module: 'map', minLevel: 100, requires: ['quest:patches:contracts'], grants: ['quest:patches:shaded'], lockouts: [] },
      { id: 'pt6', do: 'Take Patches’s Dancer’s Castanets', detail: 'He asks you to carry them back to Lady Tanith at the manor.', factId: 'quest:patches:castanets', module: 'map', minLevel: 100, requires: ['quest:patches:shaded'], grants: ['quest:patches:castanets'], lockouts: [] },
    ],
  },
  {
    id: 'roderika-hewg',
    kind: 'story',
    name: 'Roderika & Hewg',
    aliases: ['roderika', 'hewg', 'spirit tuner', 'spirit tuning'],
    lockedIf: () => null,
    // Five beats on purpose: the real line is short and closes the moment spirit
    // tuning opens. It never reaches the six-step bar the longer lines do.
    steps: [
      { id: 'rw1', do: 'Meet Roderika at the Stormhill Shack', detail: 'Limgrave, north along the Stormgate road. Exhaust her dialogue for the Spirit Jellyfish Ashes.', factId: 'quest:roderika:met', module: 'map', minLevel: 15, requires: [], grants: ['quest:roderika:met'], lockouts: [] },
      { id: 'rw2', do: 'Recover the Chrysalids’ Memento from Stormveil', detail: 'On the pile of grafted corpses in the grafting grounds before Godrick.', factId: 'quest:roderika:memento', module: 'map', minLevel: 30, requires: ['quest:roderika:met'], grants: ['quest:roderika:memento', 'item:chrysalids-memento'], lockouts: [] },
      { id: 'rw3', do: 'Give Roderika the memento', detail: 'She relocates to the Roundtable Hold after you rest at a grace.', factId: 'quest:roderika:given', module: 'quests', minLevel: 30, requires: ['quest:roderika:memento'], grants: ['quest:roderika:given'], lockouts: [] },
      { id: 'rw4', do: 'Ask Hewg to take Roderika on', detail: 'The smith at the Roundtable agrees, if reluctantly, to teach her spirit tuning.', factId: 'quest:hewg:roderika', module: 'quests', minLevel: 30, requires: ['quest:roderika:given'], grants: ['quest:hewg:roderika'], lockouts: [] },
      { id: 'rw5', do: 'Unlock spirit tuning with Roderika', detail: 'She can now upgrade your spirit ashes while Hewg keeps forging. The line is complete.', factId: 'quest:roderika:tuner', module: 'quests', minLevel: 30, requires: ['quest:hewg:roderika'], grants: ['quest:roderika:tuner'], lockouts: [] },
    ],
  },
  {
    id: 'diallos',
    kind: 'story',
    name: 'Knight Diallos',
    aliases: ['diallos', 'knight diallos', 'lanya', 'jarburg'],
    lockedIf: () => null,
    steps: [
      { id: 'dl1', do: 'Meet Diallos at the Roundtable Hold', detail: 'He frets about his servant Lanya and the name of House Hoslow.', factId: 'quest:diallos:met', module: 'quests', minLevel: 30, requires: [], grants: ['quest:diallos:met'], lockouts: [] },
      { id: 'dl2', do: 'Hear him out about Lanya', detail: 'He is searching for the servant he lost and does not know where she has gone.', factId: 'quest:diallos:lanya', module: 'quests', minLevel: 40, requires: ['quest:diallos:met'], grants: ['quest:diallos:lanya'], lockouts: [] },
      { id: 'dl3', do: 'Find Diallos at the Village of the Albinaurics', detail: 'Liurnia. He has followed a lead and is out of his depth.', factId: 'quest:diallos:village', module: 'map', minLevel: 60, requires: ['quest:diallos:lanya'], grants: ['quest:diallos:village'], lockouts: [] },
      { id: 'dl4', do: 'Follow him to Jarburg', detail: 'The jar village in Liurnia, where Jar-Bairn and the other jars live.', factId: 'quest:diallos:jarburg', module: 'map', minLevel: 60, requires: ['quest:diallos:village'], grants: ['quest:diallos:jarburg'], lockouts: [] },
      { id: 'dl5', do: 'Help defend Jarburg from the poachers', detail: 'Diallos stands with the jars against the night raid.', factId: 'quest:diallos:poachers', module: 'map', minLevel: 70, requires: ['quest:diallos:jarburg'], grants: ['quest:diallos:poachers'], lockouts: [] },
      { id: 'dl6', do: 'Find Diallos wounded and take his mask', detail: 'Jar-Bairn gives you Diallos’s Mask; the knight’s story closes at Jarburg.', factId: 'quest:diallos:concluded', module: 'map', minLevel: 70, requires: ['quest:diallos:poachers'], grants: ['quest:diallos:concluded', 'item:diallos-mask'], lockouts: [] },
    ],
  },
]
